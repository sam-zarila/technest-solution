...
const ProductDetails = {
  product: "Apple Music",
  price: "MWK 3500 per month",
};

const numericAmount = "3500"; // Fixed price

const ApplemusicPaymentPage = () => {
  ...
  return (
    <div className="p-6">
      <div className="max-w-xl mx-auto bg-gray-900 p-8 rounded-lg shadow-lg">
        <h1 className="text-center text-2xl text-white font-bold mb-8">Buy Apple Music</h1>
...
export default ApplemusicPaymentPage;
