...
const ProductDetails = {
  ...
  price: "MWK 15,000 per month",
};

const numericAmount = "15000"; // Fixed price

const ChatgptpayementPage = () => {
  ...
  return (
    <div className="p-6">
      <div className="max-w-xl mx-auto bg-gray-900 p-8 rounded-lg shadow-lg">
        <h1 className="text-center text-2xl text-white font-bold mb-8">Buy Chatgpt Plus</h1>
...
export default ChatgptpayementPage;
